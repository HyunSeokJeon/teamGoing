...
<div class="container-fluid">
	...
	<div class="col">
		<div class="card shadow mb-4">
			...
			<!-- Card Body -->
			<div class="card-body">
				<form action="<%= path %>/customerservice/createFaq.go" method="post">					
					<div class="col-md-4 mb-3">
						<label for="FAQ_Q">제목</label>
						<input type="text" class="form-control" id="FAQ_Q" name="FAQ_Q" placeholder="제목">
					</div>
					<div class="col-md-4 mb-3">
						<label for="FAQ_A">답변</label>
						<input type="text" class="form-control" id="FAQ_A" name="FAQ_A" placeholder="답변">
					</div>					
										
					<br/>
					<div class="col">
						<button type="submit" id="create_FAQ_submit"
