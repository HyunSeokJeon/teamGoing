			...
			<div
				...
				<div class="dropdown no-arrow">
					...
					<div
						...
						<form action="<%=path%>/manage/grade.go" method="post" class="form-group">
							<div class="dropdown-header">
								등급 추가 :
							</div>
							<div class="mx-2"><input class="form-control form-control-sm" placeholder="등급 이름입력" name="inputGrade"></div>
							<br>
							<div class="dropdown-header">
								등급 할인율 :
							</div>
							<div class="mx-2"><input class="form-control form-control-sm" placeholder="할인율 입력" name="inputGradeBenefits"></div>
