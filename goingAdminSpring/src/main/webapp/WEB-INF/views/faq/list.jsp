					...
					<tbody>
						...
						<c:forEach var="list" items="${list}">
							<tr>
								...
								<th><a href="/faq/updateFaq?faqNumber=${list.faqNumber}"
									class="p-2 d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">수정</a>
									<a href="/faq/delete?faqNumber=${list.faqNumber}"
									class="p-2 d-none d-sm-inline-block btn btn-sm btn-danger shadow-sm ml-2">삭제</a></th>
							</tr>
						</c:forEach>
