...
<body>
	<div class="row justify-content-center">
		<div class="col-4 text-center">
			...
			<a class="my-4" href="/main.go"><img
				src="<%=imgPath%>logo.png" /></a>
		</div>
	</div>
	<div class="form-group">
		<form action="/customer/loginPost" method="post">
			<div class="row justify-content-center my-3" >
				<div class="col-10 col-sm-3 text-center login-input">
					<input type="text" name="customerId"  class="w-100 form-control" placeholder="아이디">
					<!--<c:if test="${errors.customerId}">ID를 입력하세요.</c:if>-->
				</div>
			</div>
			<div class="row justify-content-center my-3">
				<div class="col-10 col-sm-3 text-center login-input">
					<input type="password" name="customerPass" class="w-100 form-control" placeholder="비밀번호">
					<%-- <c:if test="${errors.customerPass}">암호를 입력하세요.</c:if> --%>
				</div>
			</div>
			<div class="row justify-content-center my-3">
				...
				<div class="col-4 col-sm-1 text-center" style="min-width:8.25rem">
					<a href="/join.go"  class="w-100 btn">회원가입</a>
				</div>
