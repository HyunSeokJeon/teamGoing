...
String kakao = "https://kauth.kakao.com/oauth/authorize?client_id=7a9d7646f024ea13e76abbd9ff73055f&redirect_uri=http://localhost:8081/kakaologin&response_type=code";
%>
...
<body>
	...
	<div class="form-group">
		<form action="<%=request.getContextPath()%>/customer/loginPost" method="post">
			<div class="row justify-content-center my-3" >
				<div class="col-10 col-sm-3 text-center login-input">
					<input type="text" name="customerId" value="${param.id}" class="w-100 form-control" placeholder="아이디">
			...
			<div class="row justify-content-center my-3">
				...
				<div class="col-4 col-sm-1 text-center" style="min-width:8.25rem">
					<a href="<%=path %>/customer/join"  class="w-100 btn">회원가입</a>
				</div>
			</div>
		</form>
	</div>
	<div class="row justify-content-center my-3">
				<div class="col-6 col-sm-2 text-center" style="min-width:16.5rem">
					<a href="<%=kakao%>"><input type="image" value="카카오로그인" class="w-100 btn" src="<%=imgPath %>kakao_login_large_narrow.png"></a>
				</div>
			</div>
