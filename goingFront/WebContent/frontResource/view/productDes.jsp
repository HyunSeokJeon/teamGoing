...
<div class="container-fluid position-relative" id="page-content-wrapper">
        		...
        		<nav class="navbar navbar-expand-lg navbar-light bg-light " style="margin-top:10rem">
        			<div class="collapse navbar-collapse d-flex justify-content-center " id="navbarSupportedContent">
        				<ul class="navbar-nav mr-auto ">
	        				  <li class="nav-item dropdown">
							        <a class="nav-link fs-4" href="#" id="navbarDropdown1" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
							          Home
							        </a>
							        <!-- 
	        						...
	        						<ul class="navbar-nav mr-auto">
	        							<li class="nav-item dropdown">
	        								<a class="nav-link fs-4 " href="#" id="navbarDropdown2" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										          인기
										    </a>
										        <!--  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
										          <a class="dropdown-item" href="#">Action</a>
	        						...
	        						<ul class="navbar-nav mr-auto">
	        							<li class="nav-item dropdown">
	        								<a class="nav-link fs-4" href="#" id="navbarDropdown3" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										          브랜드
										    </a>
										    <!-- 
										        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	        						...
	        						<ul class="navbar-nav mr-auto">
	        							<li class="nav-item dropdown">
	        								<a class="nav-link fs-4" href="#" id="navbarDropdown4" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										          콘텐츠
										    </a>
										        <!-- 
										        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
	        						...
	        						<ul class="navbar-nav mr-auto">
	        							<li class="nav-item dropdown">
	        								<a class="nav-link fs-4" href="#" id="navbarDropdown5" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										          이벤트
										    </a>
										        <!-- <div class="dropdown-menu" aria-labelledby="navbarDropdown">
										          <a class="dropdown-item" href="#">Action</a>
	        						...
	        						<ul class="navbar-nav mr-auto">
	        							<li class="nav-item dropdown">
	        								<a class="nav-link fs-4" href="#" id="navbarDropdown6" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
										          마이페이지
										    </a>
										        <!--  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
										          <a class="dropdown-item" href="#">Action</a>
                ...
                <!-- Page content--> 
               	...
               	<div class=" container border-top border-bottom border-dark ">
               		...
               		<div class="summary mt-3 " >
               			<div class="row">
               				<div class=" col-4">
               					<img src="../../frontResource/dist/img/psy.jpg"  class="h-auto" align="left">
               					</div>
         ...
         <div class="dxbs-calendar card" id="Content_CalendarDefault" tabindex="0" aria-label="Calendar. Use arrow keys to navigate." data-observed="true">
         	<div class="calendar-row">
         		<div class="calendar-view card">
         			<div class="card-header btn-group">
         				<span id="Content_CalendarDefault_PYC" class="btn">
         					<span aria-hidden="true" class="dxbs-icon dxbs-icon-backward">
         					</span>
         				</span>
         				<span id="Content_CalendarDefault_PYC" class="d-none btn">
         					<span aria-hidden="true" class="dxbs-icon dxbs-icon-angle-left"></span>
         				</span>
         			</div>
         		<div class="card-body">
         			<table class="dxbs-month-table table table-sm table-bordered">
         				<tbody>
         					...
         					<tr class="text-center">
         						...
         						<td class="dxbs-day dxbs-weekend text-danger">
         							<a>5</a>
         						</td>
         					</tr>
         					<tr class="text-center">
         						...
         						<td class="dxbs-day  dxbs-weekend  table-active">
         							<a>6</a>
         						</td>
         						<td class="dxbs-day">
         							<a>7</a>
