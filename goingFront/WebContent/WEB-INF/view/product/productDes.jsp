		...
		<div class="row">
			<div class="col-8">
				<div class="row">
					<div class="col-4">
						...
						<% String img = "C:\\Temp\\"+((Prolist)request.getAttribute("product")).getProductImage(); %>
					...
					<div class="col">
						<ul class="list-group  ps-5 fs-5">
							...
							<li class="list-inline-item mt-5"><strong>가격</strong> <span
								class="ps-5"> productPrice</span></li>
			...
			<div class=" col-4 mt-3 " >
				<div class="sticky-top-sangwon">
					...
					<a class="d-flex text-center btn btn-primary  mt-5 " href="<%=path%>/payment.go?productId=${product.productID}">
									예매하기
					</a>
			</div>
		</div>
